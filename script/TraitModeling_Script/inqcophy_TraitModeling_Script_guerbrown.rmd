...
### Oak Section (Annotated Discrete)
...
### Gall Size (removed until completed)

```{r gall_size POLYMORPHIC, eval=FALSE, fig.align='center', fig.height=7, fig.width=12.5, include=FALSE}
...
### location (removed until completed)

```{r location POLYMORPHIC, eval=FALSE, fig.align='center', fig.height=7, fig.width=12.5, warning=FALSE, include=FALSE}
