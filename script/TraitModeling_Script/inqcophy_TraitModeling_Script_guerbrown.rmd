...
nodelabels(pie = oak_sectionasr, piecol = oak_sectioncols,cex=0.40)
par(fg="black")
legend("bottom", c("Lobatae", "Quercus","Virentes", "test1", "test2", "test3"), pch = 21, pt.bg = c("firebrick1", "dodgerblue1", "grey15", "pink", "orange", "yellow"), pt.cex = 2, title = "oak_section", cex = 1)
