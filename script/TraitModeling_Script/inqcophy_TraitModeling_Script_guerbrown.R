...
## ----oak_section DISCRETE ANNOTATED, fig.height=10, fig.width=12.5, fig.align='center'----
...
## ----cynip_generation POLYMORPHIC, fig.height=10, fig.width=12.5, fig.align='center'----
# First, lets isolate the variable we want to graphically model from the original imported data frame
